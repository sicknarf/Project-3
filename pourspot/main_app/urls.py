...
urlpatterns = [
    ...
    path('drinks/<int:drink_id>/add_recipe/', views.add_recipe, name="add_recipe"),
    ...
    path('ingredients/<int:drink_id>/recipes/<int:recipe_id>/', views.RecipeDetail.as_view(), name='recipe_detail'),

    ###################### NEEDS ATTENTION ######################
    # http://localhost:8000/drinks/1/recipes/create/
    path('ingredients/<int:drink_id>/recipes/create/', views.RecipeCreate.as_view(), name='recipe_create'),

    ###################### NEEDS ATTENTION ######################
    # http://localhost:8000/drinks/1/recipes/1/delete/
    path('ingredients/<int:drink_id>/recipes/<int:recipe_id>/delete', views.RecipeDelete.as_view(), name='recipe_delete'),
